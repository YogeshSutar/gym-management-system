...
<?php
        ...
        $_SESSION['status'] = "No delete record";
    ...
    <div>
        ...
        <div>
            ...
            <div style="padding-left: 200px; padding-top:40px;">
                ...
                <div class="usertablebox" id="selectusers">
                    <div class="row mt-5">
                        <div class="col" style="margin-right: -30px; padding-right: 0px; margin-left: 30px;">
                            <div class="card ms-5">
                                ...
                                <div class="card-header ">
                                    ...
                                    <h1 style="font-size: 60px; "> Users Table </h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <button style="border-radius: 10px; padding: 10px; border: none; margin-left: 14px; background: deepskyblue; font-weight: bold;"><a style="color:white; text-decoration:none;" href="admin_add_users_page.php">Add Users</a> </button>
                                        <thead>
                                        ...
                                        if (isset($_POST['filter_btn'])) {
                                            ...
                                            $query = "SELECT * FROM `users` WHERE CONCAT(id,name,email,phone,username) LIKE '%$filter_value%'";
                                         ...
                                         ?>
                                                    <tr class="innerdetail" style="color:black;">
                                                        ...
                                                        <td>
                                                            <a href="admin_panel_users.php?delete_username=' . $data['username'] . '" id="delete_user_detail" onclick="return check_delete_detail()" > <i class="fa-solid fa-trash"></i></a>
                                                        </td>';
                                                        ?>
                                                        <script>
...
<script>
    ...
    $hiddenstart.addEventListener('click', () => {
